...
#This program will compute for the final grade of the user given, the inputs are the lecture and laboratory grade.
...
while yes_or_no.upper() == "YES":
    ...
    if lecture_grade.isnumeric() == True and laboratory_grade.isnumeric() == True:
        ...
        if lecture_grade <= 100 and laboratory_grade <= 100:
            ...
            print("Your final grade is", final_grade,"\b.")
